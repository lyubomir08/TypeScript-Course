...
let maybeCar4 = {
    ...
    tires: { model: 'BRIT' }, body: { material: 'steel', weight: 2670 }
};
let maybeCar5 = {
    engine: { horsepower: '220', type: 'electric' },
...
// TS Error  mechanic.technicalInspection(maybeCar4);
// TS Error mechanic.technicalInspection(notACar);
// TS Error mechanic.technicalInspection(maybeCar);
// TS Error mechanic.technicalInspection(maybeCar3);
// TS Error mechanic.technicalInspection(maybeCar5);
